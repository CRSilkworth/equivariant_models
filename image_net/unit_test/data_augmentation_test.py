...
class TestImageGenerator(unittest.TestCase):
    def setUp(self):
        ...
        # self.mean_rgb = np.array([121.65, 116.67, 102.82], dtype=np.float32)/255.
        # self.rgb_eigenvectors = np.array(
        #     [
        #         [0.40717196, -0.7144478, -0.56901264],
        #         [-0.81252617, 0.00119385, -0.5829235],
        #         [0.4171477, 0.6996878, -0.58002144]
        #     ],
        #     dtype=np.float32
        # )
        # self.rgb_eigenvalues = np.array(
        #     [0.00360009, 0.01688914, 0.2162391],
        #     dtype=np.float32
        # )
